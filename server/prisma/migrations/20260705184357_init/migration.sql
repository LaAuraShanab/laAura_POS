...
-- CreateEnum
CREATE TYPE "InventoryChangeReason" AS ENUM ('SALE', 'RESTOCK', 'ADJUSTMENT', 'RETURN');
...
-- AddForeignKey
ALTER TABLE "inventory_history" ADD CONSTRAINT "inventory_history_updatedById_fkey" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
