  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap outline-none select-none transition-[color,background-color,box-shadow,transform] duration-150 ease-[var(--ease-standard)] active:scale-[0.98] focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        // alias of `danger` — solid fill kept from the original design (deliberately heavier
        // weight than shadcn's stock soft `destructive` treatment, for delete/destructive actions)
        danger:
          "relative isolate overflow-hidden bg-destructive text-white after:pointer-events-none after:absolute after:inset-0 after:rounded-[inherit] after:bg-white after:opacity-0 after:transition-opacity after:duration-150 after:ease-[var(--ease-standard)] hover:bg-destructive/90 active:after:opacity-[0.16]",
